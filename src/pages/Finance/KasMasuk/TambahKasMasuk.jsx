...
const TambahKasMasuk = () => {
  ...
  const [tglKasMasuk, setTglKasMasuk] = useState(nowDate);
  ...
  const saveKasMasuk = async (e) => {
    e.preventDefault();
    let isFailedValidation = tglKasMasuk.length === 0 || kodeCOA.length === 0;
        ...
        <Box sx={textFieldContainer}>
          <Box sx={textFieldWrapper}>
            ...
            <TextField
              type="date"
              size="small"
              error={error && tglKasMasuk.length === 0 && true}
              helperText={
                error && tglKasMasuk.length === 0 && "Tanggal harus diisi!"
              }
              id="outlined-basic"
              variant="outlined"
              value={tglKasMasuk}
              onChange={(e) => setTglKasMasuk(e.target.value.toUpperCase())}
            />
          </Box>
